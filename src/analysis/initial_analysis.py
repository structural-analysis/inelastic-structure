...
class InitialAnalysis:
    ...
    def update_dynamic_time_step(self, time_step):
        ...
        elastic_a2s, elastic_b2s, elastic_modal_loads, self.elastic_nodal_disp = self.get_dynamic_nodal_disp(
            time_step=time_step,
        ...
        self.elastic_members_disps = self.get_members_disps(self.structure, self.elastic_nodal_disp[0, 0])
        self.elastic_members_disps_history[time_step, 0] = self.elastic_members_disps
        internal_responses = self.get_internal_responses(self.structure, self.elastic_members_disps)
        ...
        if self.structure.is_inelastic:
            ...
            sensitivity = self.get_dynamic_sensitivity(self.structure.modes, time_step)
