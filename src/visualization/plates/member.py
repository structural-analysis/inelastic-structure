...
def plot_members(nodes, members, yield_points, plastic_points, highlight_node=None, highlight_yield=None):
    ...
    # Plot yield points
    plt.scatter(yield_points['x'], yield_points['y'], color='#1700e6', marker='x', s=15, label='Evaluation Points')
    ...
    if highlight_yield is not None:
        ...
        if not yld_point.empty:
            plt.scatter(yld_point['x'], yld_point['y'], color='#110299', marker='P', s=70, label='Monitored Evaluation Point')
