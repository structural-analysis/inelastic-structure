...
def plot_3d():
    ...
    # Plot the surfaces
    stride_size = 5
    # ax.plot_surface(my, mz1, n, color="b", alpha=0.6, edgecolor="b", linewidth=0.2, rstride=stride_size, cstride=stride_size)
    # ax.plot_surface(my, -mz1, n, color="r", alpha=0.6, edgecolor="b", linewidth=0.2, rstride=stride_size, cstride=stride_size)
    # ax.plot_surface(my, mz2, n, color="g", alpha=0.6, edgecolor="b", linewidth=0.2, rstride=stride_size, cstride=stride_size)
    # ax.plot_surface(my, -mz2, n, color="y", alpha=0.6, edgecolor="b", linewidth=0.2, rstride=stride_size, cstride=stride_size)

    ax.plot_surface(my, mz1, n, color="b", alpha=0.3)
    ax.plot_surface(my, -mz1, n, color="r", alpha=0.3)
    ax.plot_surface(my, mz2, n, color="g", alpha=0.3)
    ax.plot_surface(my, -mz2, n, color="y", alpha=0.6)
