...
class PlateMember:
    ...
    def get_response(self, nodal_disp, fixed_force=None):
        ...
        for i, element in enumerate(self.elements.list):
            ...
            yield_components_force[yield_components_start_index:yield_components_end_index, 0] = element.get_yield_components_force(elements_nodal_disps[i])
            ...
            top_internal_strains[start_index:end_index, 0] = element.get_top_internal_strains(elements_nodal_disps[i])
            bottom_internal_strains[start_index:end_index, 0] = element.get_bottom_internal_strains(elements_nodal_disps[i])
            top_internal_stresses[start_index:end_index, 0] = element.get_top_internal_stresses(elements_nodal_disps[i])
            bottom_internal_stresses[start_index:end_index, 0] = element.get_bottom_internal_stresses(elements_nodal_disps[i])
