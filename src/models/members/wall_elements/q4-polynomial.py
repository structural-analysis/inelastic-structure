...
# 1, x, xy, y, x2, x2y, xy2, y2

def get_c(natural_nodes, node_dof_count):
    # r0 = natural_nodes[0].r
    # s0 = natural_nodes[0].s
    # r1 = natural_nodes[1].r
    # s1 = natural_nodes[1].s
    # r2 = natural_nodes[2].r
    # s2 = natural_nodes[2].s
    # r3 = natural_nodes[3].r
    # s3 = natural_nodes[3].s
    nodes_count = len(natural_nodes)
    c = np.matrix(np.zeros((node_dof_count * nodes_count, node_dof_count * nodes_count)))
